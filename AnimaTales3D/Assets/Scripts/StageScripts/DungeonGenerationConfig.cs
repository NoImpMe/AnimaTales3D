...
///
/// 기본값은 기존 DungeonGridManager 인스펙터에 실제로 오버라이드돼 있던 값과 동일하게 맞춰, Config로
/// 옮기는 과정에서 생성 결과가 달라지지 않도록 했다 (2026-09-03 리팩터링).
/// hexSize는 2026-09-05 타일 크기 2배 확대 작업(LOG #12)에서 1.2 → 2.4로 갱신됨.
/// </summary>
...
{
    [Header("타일 크기 / 구역 반경")]
    [Min(0.01f)] public float hexSize = 2.4f;
